  ...
  $('#vmap-local').vectorMap({
    ...
    if (code == 'sg') {
      label.html('<span class="country-name">Singapore</span><br><span class="country-detail">PayNow, eNets, GrabPay</span>');
        ...
        label.html('<span class="country-name">Malaysia, Singapore</span><br><span class="country-detail"><b>Malaysia:</b>Maybank, Public bank, Hong Leong, CIMB<br><b>Singapore:</b>PayNow, eNets, GrabPay</span>');
    } else if (code == 'jp') {
        label.html('<span class="country-name">Japan</span><br><span class="country-detail">JCB, TigerPay</span>');
    } else if (code == 'th') {
        label.html('<span class="country-name">Thailand</span><br><span class="country-detail">Krungthai bank, Prompt pay (Thai QR)</span>');
    } else if (code == 'vn') {
        label.html('<span class="country-name">Vietnam</span><br><span class="country-detail">Momo, ViettelPay, ZaloPay, Asia commercial bank, DongA bank, BIDV, Sacombank, Techcombank, Vietcombank, Vietin bank</span>');
          ...
          label.html('<span class="country-name">Philippines</span><br><span class="country-detail">GCash</span>');
    } else if (code == 'au') {
