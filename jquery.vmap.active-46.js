$(function() {
  ...
  $('#vmap-local').vectorMap({
    ...
    selectedRegions: ['sg', 'my', 'jp', 'th', 'vn', 'ph', 'au', 'kr', 'hk', 'nz', 'om', 'qa', 'sa', 'ae', 'br', 'mx', 'co', 'cl', 'pa', 'pe', 'ar', 'eg', 'gh', 'ng', 'za', 'ke', 'tz', 'ug', 'id'], // Add all selected country code
    ...
    if (code == 'sg') {
      label.html('<span class="country-name">Singapore</span><br><span class="country-detail">QR Payment - PayNow<br />Local Payment - eNets, GrabPay<br />Internet Banking - DBS, OCBC Bank, UOB, Standard Chartered</span>');
    } else if (code == 'my') {
        label.html('<span class="country-name">Malaysia, Singapore</span><br><span class="country-detail"><b>Malaysia:</b>QR Payment - Touch n Go<br />Local Payment - FPX, Boost, DuitNow, GrabPay, ShopeePay<br />Internet Banking - CIMB, Maybank, Public Bank, Hong Leong, RHB<br><b><br>Singapore:</b>QR Payment - PayNow<br />Local Payment - eNets, GrabPay<br />Internet Banking - DBS, OCBC Bank, UOB, Standard Chartered</span>');
    } else if (code == 'jp') {
        label.html('<span class="country-name">Japan</span><br><span class="country-detail">Card - JCB Card<br />Bank Transfer - All Banks</span>');
    } else if (code == 'th') {
        ...
        label.html('<span class="country-name">Vietnam</span><br><span class="country-detail">QR Payment - Viet QR<br />Local Payment - Momo Pay, Viettel Money, Zalo Pay<br />Intenet Banking - Asia Commercial Bank, DongA Bank, BIDV, Sacombank, Techcombank, Vietcombank, Vietin Bank</span>');
    } else if (code == 'ph') {
          label.html('<span class="country-name">Philippines</span><br><span class="country-detail">Local payment - GCash, PayMaya, Shopee Pay, Grab Pay</span>');
    } else if (code == 'au') {
        ...
        label.html('<span class="country-name">Indonesia</span><br><span class="country-detail">Local Payment - OVO, Shopee Pay, Dana<br />Bank Transfer - Mandiri, BCA</span>');
    } else if (code == 'tr') {
